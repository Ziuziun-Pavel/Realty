...
describe('NewsListComponent', () => {
  ...
  it('should display newsCards', () => {
    spyOn(newsService, 'getNews').and.returnValue(of(mockNewsRequest));
    component.ngOnInit();
    component.newsCards.subscribe(news => {
      expect(news).toEqual(mockNewsRequest);
    });
  });
